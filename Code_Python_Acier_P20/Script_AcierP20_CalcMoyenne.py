...
fichier1 = 'AcierP20-repet1-traite.txt'
...
nom_fichier_sortie_png = 'AcierP20_Moy.png'
nom_fichier_sortie_txt = 'AcierP20_Moy'
...
indice_min = min(i1,i2)
indice_max = max(i1,i2)
...
T_vf_list= np.array([T_vf1_corr, T_vf2_corr])
...
for k in range(0,n_sortie_off):
        TVF_MOY[k]    = (T_vf1_corr[k] + T_vf2_corr[k])/2 
